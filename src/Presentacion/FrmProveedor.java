  ...
  void CrearTabla(){
   ...
   void modificar(){
    ...
    void actualizarTabla(){
       String titulos[]={"ID","Nombre o Razón Social","NIT","CI","Dirección","Teléfono","Celular","Email","Nº Cuenta 1","Nº Cuenta 2","Estado","Observación"};
   ...
   void BuscarProveedor(){
    ...
    private void initComponents() {
        ...
        btnModificar.setBounds(731, 160, 130, 70);
        ...
        btnCancelar.setBounds(731, 230, 130, 70);
        ...
        btnNuevo.setBounds(731, 20, 130, 70);
        ...
        btnSalir.setBounds(731, 300, 130, 70);
        ...
        pBuscar.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 28, 170, 50));
        ...
        pBuscar.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 690, 80));
        ...
        pBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 690, 230));
        ...
        pNuevo.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 335));
        ...
        pNuevo.add(txtRuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 210, -1));
        ...
        pNuevo.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 120, 210, -1));
        ...
        pNuevo.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 210, -1));

        jLabel8.setText("C.I:");
        pNuevo.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 90, 30, 20));
        ...
        pNuevo.add(txtDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 90, 150, -1));

        jLabel9.setText("Observación:");
        pNuevo.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 70, 20));

        txtObservacion.setColumns(20);
        txtObservacion.setRows(5);
        jScrollPane2.setViewportView(txtObservacion);

        pNuevo.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 540, 50));

        jLabel10.setText("Celular:");
        pNuevo.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 120, 45, 20));
        ...
        pNuevo.add(txtCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 120, 150, -1));
        ...
        pNuevo.add(rbtnActivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, 70, -1));

        rbtnInactivo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        rbtnInactivo.setText("INACTIVO");
        rbtnInactivo.setOpaque(false);
        pNuevo.add(rbtnInactivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 30, 80, -1));

        jLabel11.setBorder(javax.swing.BorderFactory.createTitledBorder("Estado"));
        pNuevo.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 190, 45));
        ...
        pNuevo.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 210, -1));

        jLabel4.setText("Nº Cuenta 1:");
        pNuevo.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 150, 70, 20));

        jLabel15.setText("Nº Cuenta 2:");
        pNuevo.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, 70, 20));
        ...
        pNuevo.add(txtCuenta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 150, -1));
        ...
        pNuevo.add(txtCuenta2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 180, 150, -1));
        ...
        tabProveedor.setBounds(10, 10, 710, 380);
