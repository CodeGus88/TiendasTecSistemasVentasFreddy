...
//-----------------------------------------------------------------------------------------------
  ...
  void BuscarCompraDetalle(){
    ...
    private void initComponents() {
        ...
        dcFechafin.setBounds(150, 40, 110, 40);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("DOCUMENTO:");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(280, 20, 80, 20);
        ...
        cboTipoDocumento.setBounds(280, 40, 150, 40);
        ...
        btnBuscar.setBounds(600, 20, 120, 50);
        ...
        btnAnularCompra.setBounds(470, 20, 110, 50);
