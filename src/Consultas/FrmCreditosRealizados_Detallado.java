...
public class FrmCreditosRealizados_Detallado extends javax.swing.JInternalFrame {
    ...
    String Total; //documento,criterio,busqueda,
    boolean valor=true;
    int n=0;
    
    public FrmCreditosRealizados_Detallado() {
        initComponents();
        ...
        CantidadTotal();
        VentasCreditoTotal();
        CantidadVentaCredito();
        GananciaVentaCredito();
    }
...
//-----------------------------------------------------------------------------------------------
   ...
   //--------------------PRESENTACION DE JTABLE----------------------
        ...
        //Agregar Render
        for (int i=0;i<tblVentaCredito.getColumnCount();i++){
            tblVentaCredito.getColumnModel().getColumn(i).setCellRenderer(render);
        }
      
        //Activar ScrollBar
        tblVentaCredito.setAutoResizeMode(tblVentaCredito.AUTO_RESIZE_OFF);

        //Anchos de cada columna
        int[] anchos = {120,270,120,80,80,80,80,80};
        for(int i = 0; i < tblVentaCredito.getColumnCount(); i++) {
            tblVentaCredito.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
        //Ocultar columnas
        ocultarColumnas(tblVentaCredito,new int[]{3});
  ...
  void BuscarVentaCredito(){
        ...
        try{
            rs=ventaCredito.listarCreditoPorDetalle("consultar",fecha_ini,fecha_fin);
        ...
        tblVentaCredito.setModel(dtm);
    }
      
   
  
    void CantidadTotal(){
        Total= String.valueOf(tblVentaCredito.getRowCount());   
    ...
    void VentasCreditoTotal(){
        Double Total_venta_credito=0.0;    
        int fila = 0;
        fila = dtm.getRowCount();
        for (int f=0; f<fila; f++){
            Total_venta_credito += Double.parseDouble(String.valueOf(tblVentaCredito.getModel().getValueAt(f, 6)));            
        }
        txtTotalVentaCredito.setText(String.valueOf(Total_venta_credito));
    }
    void CantidadVentaCredito(){
        Double cantidad=0.0;    
        int fila = 0;
        fila = dtm.getRowCount();
        for (int f=0; f<fila; f++){
            cantidad += Double.parseDouble(String.valueOf(tblVentaCredito.getModel().getValueAt(f, 5)));            
        }
        txtCantidad.setText(String.valueOf(cantidad));
    }
    void GananciaVentaCredito(){
        Double ganancia=0.0;    
        int fila = 0;
        fila = dtm.getRowCount();
        for (int f=0; f<fila; f++){
            ganancia += Double.parseDouble(String.valueOf(tblVentaCredito.getModel().getValueAt(f, 7)));            
        }
    ...
    private void initComponents() {
        ...
        tblVentaCredito = new javax.swing.JTable();
        ...
        txtTotalVentaCredito = new javax.swing.JTextField();

        setBackground(new java.awt.Color(255, 255, 255));
        setClosable(true);
        setIconifiable(true);
        setTitle("Reporte de ventas a crédito al detalle");
        getContentPane().setLayout(null);

        tblVentaCredito.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblVentaCredito.setRowHeight(22);
        tblVentaCredito.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblVentaCreditoMouseClicked(evt);
            }
        });
        jScrollPane5.setViewportView(tblVentaCredito);
        ...
        txtTotalVentaCredito.setBackground(new java.awt.Color(254, 254, 224));
        txtTotalVentaCredito.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtTotalVentaCredito.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel2.add(txtTotalVentaCredito, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 43, 90, 30));
    ...
    private void tblVentaCreditoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVentaCreditoMouseClicked

    }//GEN-LAST:event_tblVentaCreditoMouseClicked
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            report=JasperCompileManager.compileReport(new File("").getAbsolutePath()+ "/src/Reportes/RptCreditoDetallado.jrxml");
    ...
    private javax.swing.JTable tblVentaCredito;
    private javax.swing.JTextField txtCantidad;
    private javax.swing.JTextField txtGanancia;
    private javax.swing.JTextField txtTotalVentaCredito;
