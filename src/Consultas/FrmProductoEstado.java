...
//                            String ruta="src/Images/"+Paths.DEFAULT_PRODUCT_IMAGE_WHITE;
...
//                            lblImagen.setIcon(icono);
                            ImageLoader.setImage(lblImagen, Paths.DEFAULT_PRODUCT_IMAGE_BLANCK);
                    }
                   break;
                }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Igresar el código de barras del producto");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 10, 290, 20);
        ...
        txtCodigoProducto.setBounds(10, 30, 380, 30);
        ...
        lblImagen.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        lblImagen.setForeground(new java.awt.Color(255, 255, 255));
        lblImagen.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblImagen.setText("PHOTO");
        lblImagen.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        lblImagen.setOpaque(true);
        getContentPane().add(lblImagen);
        lblImagen.setBounds(400, 30, 280, 270);
